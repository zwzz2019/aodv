...
static ssize_t kaodv_expl_proc_info(struct file *file, char *buffer, size_t length, loff_t *offset)
{
	char data[512];	
	loff_t pos=*offset;
...
void kaodv_expl_init(void)
{
	...
	proc_create("kaodv_expl", 0, init_net.proc_net, &fops_expl);
#endif
